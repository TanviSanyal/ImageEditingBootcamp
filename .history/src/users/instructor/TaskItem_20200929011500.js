                ...
                <Card className="task-item__content">
                    ...
                    <div className="task-item__info">
                       ...
                       <br/> <h3>Editing Details : {props.description}</h3><br/>
                        {auth.isLoggedIn && <Link to={`/instructor/InstructorId/${props.id}/submissions`}><h3 className="totalsubmissions">{props.submission} {(props.submission===1)?'submission':'submissions'}</h3></Link>}
                    </div>
