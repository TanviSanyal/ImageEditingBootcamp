...
const Auth = (props) => {
    ...
    return (
        ...
        <Card className="authentication">
            ...
            <hr />
            <form onSubmit={authSubmitHandler} action="/instructor">
                ...
                <Input id="password"
                    ...
                    onInput={inputHandler}
                />
                {/* <Button type="submit" disabled={!formState.isValid} id="login_signup" >
                    {isLoginMode? 'LOGIN' : 'SIGNUP'}
                    </Button> */}
                    <Link to="/student"><Button type="submit" disabled={!formState.isValid} >
                    {isLoginMode ? 'LOGIN' : 'SIGNUP'}
                </Button></Link>
                {/* <input type ="submit" name ="submit" value={isLoginMode? 'LOGIN' : 'SIGNUP'} id="login_signup"  /> */}
            </form>
